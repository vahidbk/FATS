...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.loginEasyTraderButton.setText(_translate("Dialog", "loginEasyTrader"))
        self.saveCookieToDBButton.setText(_translate("Dialog", "saveCookieToDB"))
        self.loadCookieFromDBButton.setText(_translate("Dialog", "loadCookieFromDB"))
