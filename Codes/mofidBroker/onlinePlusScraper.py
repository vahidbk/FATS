...
#         url="https://onlineplus.mofidonline.com/Home/Default/page-1"
...
#         self.doOperationAt_Time(8,10,00,0.0)
...
#         self.doOperationAt_Time(8,29,59,0.0)
