...
orderFile = 'D:/Programming/Project/FATS/DB/MofidOnlineOrderFile.json'
showUI = True
...
def loadAllsendBuyRequest():
    ...
    for orderData in orderFileDatas:
        if (orderData["status"].strip().lower()=="NotDone"):
            continue
        # orderCount=orderData["orderCount"]
        # orderPrice=orderData["orderPrice"]
		# isin=orderData["isin"]
        ...
        hour=absoluteTime[0]
        minute=absoluteTime[1]
        second=absoluteTime[2]
        microSecond=absoluteTime[3]*0.000001
